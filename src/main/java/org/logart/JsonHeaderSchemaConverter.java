 ...
 */
public class JsonHeaderSchemaConverter extends AbstractKafkaSchemaSerDe implements Converter {
    public static final String X_JSON_HEADER_SCHEMA_ID = "x-json-header-schema-id";
    ...
    public JsonHeaderSchemaConverter() {
    }

    @VisibleForTesting
    public JsonHeaderSchemaConverter(SchemaRegistryClient client) {
    ...
    private static class Serializer<T> extends KafkaJsonHeaderSchemaSerializer<T> {
        ...
        public byte[] serialize(
                String topic, Headers headers, boolean isKey, T value, JsonSchema schema) {
            if (value == null) {
                return null;
            }
    ...
    private static class Deserializer<T> extends KafkaJsonHeaderSchemaDeserializer<T> {
